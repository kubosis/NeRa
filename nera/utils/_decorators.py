...
def ssh_tunnel(fun):
    ...
    def wrap(*args, **kwargs):
        ssh_host, ssh_user, ssh_pkey, kwargs = process_kwargs(
        ...
        logger.info(
            f"Trying to establish connection with host {ssh_host} for user {ssh_user}"
        )
        ...
        with SSHTunnelForwarder(
            ...
            # give reference of server to decorated fun
            kwargs["ssh_server"] = server
