...
class GConvGRU(torch.nn.Module):
    ...
    def __init__(
        ...
        if init_ones_:
            self._init_ones(self.conv_x_z)
            self._init_ones(self.conv_x_r)
            self._init_ones(self.conv_x_h)
            self._init_ones(self.conv_h_r)
            self._init_ones(self.conv_h_h)
            self._init_ones(self.conv_h_z)

    def _init_ones(self, model):
