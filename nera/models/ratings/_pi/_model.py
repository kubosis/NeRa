...
class PiModel(_GeneralRating):
    ...
    def __init__(self, team_count: int, default: float = 1000., **kwargs):
        ...
        self.home_rating = nn.Parameter(torch.full((team_count,), default, dtype=torch.float64))
        self.away_rating = nn.Parameter(torch.full((team_count,), default, dtype=torch.float64))
